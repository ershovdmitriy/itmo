...
public class CommandMapForHumanBeing implements CommandMap<LinkedHashMap<String, ServerCommand>>{
    ...
    public CommandMapForHumanBeing(HumanBeingManagers humanBeingManagers, IdManager<HumanBeing> idManager){
        ...
        commandMap.put("replace_if_lowe", new ReplaceIfLowe<>(humanBeingManagers, new HumanBeingComparator()));
