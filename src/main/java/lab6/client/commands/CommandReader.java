    ...
    public void executeCommand(String[] args) {
        ...
        if (args[0].equals("execute_script")){
            ...
            try {
                ...
                throw new CommandException("Выполнение команды " + args[0] + " пропущено из-за неправильных предоставленных аргументов:\n" + e.getMessage());
            } catch (ServerUnavailableException e){
                throw new CommandException("Выполнение команды " + args[0] + " прервано из-за ошибки работы с сервером:\n" + e.getMessage());
            } catch (Exception e) {
                throw new CommandException("В командном менеджере произошла непредвиденная ошибка:\n" + e.getMessage());
            }
        }
    }
