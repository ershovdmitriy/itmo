...
public class HumanBeing implements Comparable<HumanBeing>, HavingId {
    ...
    public HumanBeing(int id, String name, Coordinates coordinates, Date creationDate, Boolean realHero, boolean hasToothpick, Long impactSpeed, String soundtrackName, long minutesOfWaiting, WeaponType weaponType, Car car){
        this.id = id;
        this.name = name;
    ...
    public String toString(){
        ...
        result +=", soundtrackName = " + soundtrackName +
