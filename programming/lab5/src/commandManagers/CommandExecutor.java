    ...
    public void executeCommand(String[] args) {
        if (!commandMap.containsKey(args[0])) {
            ...
            try {
                ...
                throw new CommandInterruptedException("Выполнение команды пропущено из-за неправильных предоставленных аргументов! (" + e.getMessage() + ")");
            } catch (Exception e) {
                throw new CommandInterruptedException("В командном менеджере произошла непредвиденная ошибка!");
            }
        }
    }
